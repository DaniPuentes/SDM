...
subtitle: "Modelos de distribución de especies"
author: 
  - "Original version from Adam B. Smith, Danielle Svehla & Camilo Sanín"
  - "Adapted by Johan Calderón. Date: October 2025"
  - "Updated by Daniela A. Puentes Herrera & Mateo Cabal"
date: "2025-10-23"
output:
  html_document:
    theme: cosmo
...
Qué hicieron? El objetivo es reducir la autocorrelación espacial y evitar que el modelo se sobreajuste a zonas con mucho muestreo. Entrenaron un nuevo modelo de MaxEnt con los registros ya filtrados y un fondo aleatorio.
Esto se llama bias correction by spatial filtering.
